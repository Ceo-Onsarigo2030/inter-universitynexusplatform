      ...
      <section className="py-16 surface-ink">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 text-cream">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            <Button asChild className="bg-gold text-ink hover:bg-gold/90 font-semibold"><a href="https://baconnect.org" target="_blank" rel="noreferrer">B.A Connect Org. website <ExternalLink className="size-4" /></a></Button>
          </div>
        </div>
      </section>
